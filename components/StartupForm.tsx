...
const StartupForm = () => {
  ...
  const handleFormSubmit = async (prevState: any, formData: FormData) => {
    try {
      ...
      // condition if an error occurred
      if (error instanceof z.ZodError) {
        const fieldErrors = error.flatten().fieldErrors;

        setErrors(fieldErrors as unknown as Record<string, string>); // This line is for typescript to make it happy
    ...
    return {
      // return this if any unexpected error has occurred
      ...prevState,
    ...
    <form action={formAction} className="startup-form">
      ...
      <div>
        ...
        <Input
          ...
          className="startup-form_input"
          required
          placeholder="Startup Image URL (Please avoid .svg and .webp links)"
        />
